/*
Operations on a sequence of items, common to both ListBlock and 
StreamBlock.

These assume the presence of a container element named 
"{prefix}-container" for each list item, and certain hidden fields such 
as "{prefix}-deleted" as defined in sequence_member.html, but make no 
assumptions about layout or visible controls within the block.

For example, they don't assume the presence of a 'delete' button - it's 
up to the specific subclass (list.js / stream.js) to attach this to the 
SequenceMember.delete method.

CODE FOR SETTING UP SPECIFIC UI WIDGETS, SUCH AS DELETE BUTTONS OR 
MENUS, DOES NOT BELONG HERE.
*/
(function($) {
    django.SequenceMember = function(sequence, prefix) {
        var self = {};
        self.prefix = prefix;
    ...
    django.Sequence = function(opts) {
        ...
        self.insertMemberBefore = function(otherMember, template) {
            ...
            var newMember = django.SequenceMember(self, newMemberPrefix);
        ...
        for (var i = 0; i < count; i++) {
            ...
            var sequenceMember = django.SequenceMember(self, memberPrefix);
